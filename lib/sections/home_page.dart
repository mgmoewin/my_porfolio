...
class _HomepageState extends State<Homepage> {
  ...
  void initState() {
    super.initState();
    navKeys = {'Overview': heroKey, 'About': aboutKey, 'Stack': stackKey, 'Projects': projectsKey, 'Contact': contactKey};
  }
      ...
      builder: (context, screenSize) {
        ...
        return Scaffold(
          ...
          appBar: PreferredSize(
            ...
            child: Header(isMobile: isMobile, onNavItemTap: _scrollToSection, navKeys: navKeys),
          ),
          drawer: isMobile
 ...
 class Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [ // This is the glass card with the nav items
          Row(
            children: [
              Text(
                'MW',
              ...
              ..._buildNavItems(context, onNavItemTap, navKeys),
              IconButton(
                icon: Icon(
                  isDark ? Icons.light_mode : Icons.dark_mode,
                  color: theme.colorScheme.onSurface,
  ...
  List<Widget> _buildNavItems(
      BuildContext context, void Function(GlobalKey) onNavItemTap, Map<String, GlobalKey> navKeys) {
